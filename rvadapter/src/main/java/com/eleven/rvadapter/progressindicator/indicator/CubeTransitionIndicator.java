package com.eleven.rvadapter.progressindicator.indicator;
...
/**
 * by Jack on 2015/10/18.
 */
public class CubeTransitionIndicator extends BaseIndicatorController {

    private final float[] translateX = new float[2];
    private final float[] translateY = new float[2];
