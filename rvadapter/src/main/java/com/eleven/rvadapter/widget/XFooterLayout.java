...
import com.eleven.rvadapter.progressindicator.AVLoadingIndicatorView;
import com.eleven.rvadapter.progressindicator.ProgressStyle;


public class XFooterLayout extends LinearLayout implements BaseRefreshHeader {
    ...
    public XFooterLayout(Context context) {
        super(context);
        initView();
    }
    ...
    private void init() {
        mContainer = LayoutInflater.from(getContext()).inflate(R.layout.rv_listview_footer, null);
    ...
    public void setState(int state) {
        ...
        switch (state) {
            case STATE_NORMAL:
                ...
                mStatusTextView.setText(R.string.listview_footer_hint_normal);
                break;
